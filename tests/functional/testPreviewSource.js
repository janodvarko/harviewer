...
define([
  ...
  registerSuite('testPreviewSource', {
    'testPreviewSource': function() {
      ...
      var utils = new DriverUtils(this.remote);
      return testPreviewSource(this.remote, json)
    ...
    'testPreviewSource - Invalid JSON syntax': function() {
      var json = 'a';

      var utils = new DriverUtils(this.remote);
      return testPreviewSource(this.remote, json)
        .then(utils.cbAssertElementContainsText("css=.errorTable .errorMessage", "Failed to parse JSON"));
    },
  });
});
