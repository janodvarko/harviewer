...
HAR.strings = {
    ...
    "button.Hide_Page_Stats": "Hide Statistics",
    "button.Save": "Save To File",

    "label.Page_Load": "Load",

    "tooltip.Download_HAR_File": "Download Data As HAR File",

    "pie.label.DNS": "DNS",
    "pie.label.SSL": "SSL/TLS",
    "pie.label.Connect": "Connect",
    "pie.label.Blocked": "Blocked",
    "pie.label.Send": "Send",
    "pie.label.Wait": "Wait",
    "pie.label.Receive": "Receive",

    "pie.label.From_Cache": "From Cache",

    "request.menu.Open Request in New Window": "Open Request in New Window",
    "request.menu.Open Response in New Window": "Open Response in New Window",
    "request.menu.Break Timeline Layout": "Break Timeline Layout"
};
